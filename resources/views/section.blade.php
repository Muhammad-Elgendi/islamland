				...
				@endforeach
					...
					{{--
						...
						<div class="carousel slide quran-Carousel" data-ride="carousel" data-interval="false">
							...
							{{--
							<a class="right carousel-control" href=".quran-Carousel" role="button" data-slide="prev">
							<span id="counter-content-prev"  class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
							  <span class="sr-only">Previous</span>
							</a>
							
							<a  class="left carousel-control" href=".quran-Carousel" role="button" data-slide="next">
							<span id="counter-content-next" class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
